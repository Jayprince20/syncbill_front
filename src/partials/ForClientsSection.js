...
//import syn 2L from '../images/syn 2L.svg';
                ...
                <div class="mt-24">
                    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        ...
                        <div className="max-w-3xl mx-auto text-center pb-3 md:pb-9">
                            <h2 className="h2 mb-4">How Syncbills works</h2>
                            ...
                            <h4 className="h4 mt-8">Easy to Use</h4>
                        </div>
                        {/* Left col */}
                        <div class="w-full md:w-1/2 py-6 text-center">
                            <img class="w-full md:w-4/5 z-50" src={require("../images/syn 2L.svg").default}
                                alt="" />
                        </div>
                    ...
                    <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                        <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fillRule="evenodd">
                                <rect className="fill-current text-green-950" width="64" height="64" rx="32" />
                                <g strokeWidth="2">
                        ...
                        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Easy to Subscribe</h4>
